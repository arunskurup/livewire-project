<div>
   <form wire:submit.prevent="save"class="flex flex-col w-[400px] mx-auto py-16">
    ...
    @endif
         ...
         <button type="submit" class="py-2 px-4 bg-indigo-500 hover:bg-slate-600 rounded text-white">Save Photo</button>

   </form>

   <div class="flex flex-wrap gap-7">
           @foreach ($images as $item)
           <img src="{{$item}}" class="w-[128px] h-[120px] object-cover" >
           @endforeach
   </div>
</div>
